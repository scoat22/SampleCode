...
As of Feb 2-24-25, it's my most complex game implementation. The actual game isn't very complicated, but the engine is custom and pretty advanced. I know it looks 2D (that's just the art style). It's fully 3D capable, you can look at the code.
