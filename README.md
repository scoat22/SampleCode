...
## Kart Racer
Regarding my game programming knowledge for a Kart Racer game:<br />
-I made a cart racing game in C++ for one of my classes at University. It was a pretty simple game but I thought that might be relevant. The game imported models for the cart and track. It also accepted waypoint positions for the "enemy" carts to follow. And a heightmap that defined the height of the track at each location.<br />
