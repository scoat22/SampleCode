...
When debugging, it's essential to use breakpoints, step through code, and utilize the watch window. The watch window lets you see variable (memory) values without having to tediously add print statements everywhere. This tremendously speeds up development time. 
